...
/*
 * Representamos la transicion del NFA.
 *
 * from: estado origen
 * to: estado destino
 * symbol: caracter que provoca la transicion
 * epsilon: indica si la transicion es epsilon
 */
typedef struct
{
    int from;
...
/*
 * Obtiene el e-closure de un conjunto de estados.
